...
class InfobipMobilemessaging {
  ...
  static final StreamSubscription _libraryEventSubscription =
      _libraryEvent.receiveBroadcastStream().listen(
    (dynamic event) {
  ...
  @Deprecated(
    "setupiOSChatSettings is deprecated. Please use setChatCustomization instead",
  )
  ...
  static Future<void> submitEvent(Object customEvent) async =>
      await _channel.invokeMethod('submitEvent', jsonEncode(customEvent));
  ...
  static Future<void> submitEventImmediately(Object customEvent) async =>
      await _channel.invokeMethod(
        'submitEventImmediately',
        jsonEncode(customEvent),
      );
  ...
  static Future<void> sendContextualData(
    ...
    bool allMultiThreadStrategy,
      ...
      await InfobipMobilemessaging.sendContextualDataWithStrategy(
        data,
        allMultiThreadStrategy
            ? ChatMultithreadStrategies.all
  ...
  static Future<void> sendContextualDataWithStrategy(
    ...
    ChatMultithreadStrategies chatMultithreadStrategy =
      ...
      await _channel.invokeMethod('sendContextualData', {
        'data': data,
        'chatMultiThreadStrategy': chatMultithreadStrategy.stringValue
      });
  ...
  static Future<void> restartConnection() async {
    ...
    return await _channel.invokeMethod('restartConnection');
  }
  ...
  static Future<void> setChatPushTitle(String? title) async {
    ...
    return await _channel.invokeMethod('setChatPushTitle', title);
  }

  /// Sets body for in-app chat notifications and overrides default values.
  /// Supported only on Android.
  static Future<void> setChatPushBody(String? body) async {
    if (!Platform.isAndroid) {
      log("It's supported only on the Android platform");
      return;
    }
    return await _channel.invokeMethod('setChatPushBody', body);
  }
